...
function sendComic( $to, $subject, $message, $attachments = array() ) {
	$headers   = array();
	$headers[] = "To: {$to}";
	$headers[] = 'From: Team Comic <comics@neeraj.com>';
	$headers[] = 'Reply-To: Neeraj Singh <neeraj190499@gmail.com>';
...
function sendMail( $to, $subject, $message ) {
	$headers  = 'From: neeraj190499@gmail.com' . "\r\n";
	$headers .= 'Content-type: text/html; charset=UTF-8' . "\r\n";
